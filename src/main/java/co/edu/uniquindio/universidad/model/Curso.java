...
public class Curso {
    ...
    public Curso(String nombre, int semestre, String grupo, int creditos, String jornada, Estudiante estudiante1,
                 Estudiante estudiante2, Estudiante estudiante3, Docente docente) {
        this.nombre = nombre;
